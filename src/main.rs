// source: https://github.com/bevyengine/bevy/blob/v0.12.1/examples/games/game_menu.rs
...
fn main() {
    App::new()
        ...
        .add_plugins(game_state::GameStatePlugins)
        .run();
}
...
pub mod game_state {
    ...
    pub mod menu {
        ...
        fn spawn_button<T: Component>(
            ...
            button_action: T,
            button_icon: Option<(&'static str, &Res<AssetServer>)>,
            ...
            parent
                ...
                .with_children(|parent| {
                    if let Some((button_icon, asset_server)) = button_icon {
                        let icon = asset_server.load(button_icon);
                        parent.spawn(ImageBundle {
                ...
                .with_children(|parent| {
                    parent
                        ...
                        .with_children(|parent| {
                            ...
                            // - settings
                            // - quit
                            for (button_action, button_icon, button_text) in [
                                (
            ...
            commands
                ...
                .with_children(|parent| {
                    parent
                        ...
                        .with_children(|parent| {
                            for (button_action, button_text) in [
                                (MenuButtonAction::SettingsDisplay, "Display"),
                                (MenuButtonAction::SettingsSound, "Sound"),
                                (MenuButtonAction::BackToMainMenu, "Back"),
                            ] {
                                spawn_button(parent, button_action, None, button_text);
                            }
                        });
                });
        }
